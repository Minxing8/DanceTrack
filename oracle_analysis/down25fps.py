...
target_folder = "/home/minxing/datasets/NSVA_157_person/test_downsampled_25fps"
    ...
    with open(source_seqinfo_file, 'r') as f_in, open(target_seqinfo_file, 'w') as f_out:
        for line in f_in:
            if line.startswith('frameRate'):
                f_out.write('frameRate=25\n')  
            else:
                f_out.write(line)

print("Downsample to 25fps process completed.")
