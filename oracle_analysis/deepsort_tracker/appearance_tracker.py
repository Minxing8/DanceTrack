...
#             track.predict(self.kf)
            track.predict_appearance(self.kf)
...
#                 self.kf, detections[detection_idx])
            self.tracks[track_idx].update_appearance(
                self.kf, detections[detection_idx])
...
#         for bbox in output_results[:, :4]:
#             cv2.rectangle(ori_img, (int(bbox[0]), int(bbox[1])), (int(bbox[2]), int(bbox[3])), (255,255,255), thickness=2)
#         cv2.imwrite('show.png', ori_img)
